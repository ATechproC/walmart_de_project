{% set configs = [
    {
        "table" : "walmart.silver_tech.orders_tech",
        "alias" : "o",
        "columns" : """
            o.order_id,
            o.order_timestamp,
    ...
    {
        "table" : "walmart.silver_tech.order_items_tech",
        "alias" : "oi",
        "columns" : """
            oi.order_item_id,
            oi.quantity,
    ...
    {
        "table" : "walmart.silver_tech.stores_tech",
        "alias" : "s",
        "columns" : """
            s.store_id,
            s.store_name,
        ...
        """,
        "join_condition" : "s.store_id = o.store_id"
    },
    {
        "table" : "walmart.silver_tech.customers_tech",
        "alias" : "c",
        "columns" : """
            c.customer_id,
    ...
    {
        "table" : "walmart.silver_tech.products_tech",
        "alias" : "p",
        "columns" : """
            p.product_id,
            p.product_name,
    ...
    {
        "table" : "walmart.silver_tech.employees_tech",
        "alias" : "e",
        "columns" : """
            e.employee_id,
        ...
        """,
        "join_condition" : "e.store_id = s.store_id"
    }
] %}
